...
SuppliersActions.deleteJobsForProvider = id => {
  return function(dispatch) {
  ...
  return function(dispatch) {
    ...
    var config = {
      onUploadProgress: function(progressEvent) {
        ...
        dispatch(
          sendData(percentCompleted, types.UPDATED_FILE_UPLOAD_PROGRESS)
        );
      },
      ...getConfig()
    };
    ...
    return axios
      ...
      .then(function(response) {
        dispatch(
          SuppliersActions.addNotification('Uploaded file(s)', 'success')
        );
        dispatch(
          SuppliersActions.logEvent({
    ...
    providerList.forEach(provider => {
      ...
      return axios({
        ...
        .then(function(response) {
          ...
          dispatch(
            sendData(providerStatus, types.RECEIVED_ALL_SUPPLIERS_STATUS)
          );
        })
        .catch(function(response) {
          dispatch(sendData(response.data, types.ERROR_SUPPLIER_STATUS));
...
SuppliersActions.getChouetteJobsForAllSuppliers = () => {
  return function(dispatch, getState) {
    ...
    const url =
      window.config.mardukBaseUrl +
      `admin/services/chouette/jobs?${queryString}`;
  ...
  return function(dispatch) {
    ...
    return axios({
      ...
      .then(function(response) {
        ...
        dispatch(
          SuppliersActions.addNotification('Transfer started', 'success')
        );
        dispatch(
          SuppliersActions.logEvent({
  ...
  return function(dispatch) {
    ...
    return axios({
      ...
      .catch(function(response) {
        ...
        dispatch(
          SuppliersActions.addNotification('Validation failed', 'error')
        );
        dispatch(
          SuppliersActions.logEvent({
  ...
  return function(dispatch) {
    ...
    return axios({
      ...
      .catch(function(response) {
        ...
        dispatch(
          SuppliersActions.addNotification('Graph build failed', 'error')
        );
  ...
  return function(dispatch) {
    ...
    return axios({
      ...
      .catch(function(response) {
        ...
        dispatch(
          SuppliersActions.addNotification('OSM update failed', 'error')
        );
