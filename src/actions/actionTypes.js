...
export const ERROR_BUILD_CANDIDATE_GRAPH_OTP = 'ERROR_BUILD_CANDIDATE_GRAPH_OTP';
export const REQUEST_BUILD_CANDIDATE_GRAPH_OTP = 'REQUEST_BUILD_CANDIDATE_GRAPH_OTP';
export const SUCCESS_BUILD_CANDIDATE_GRAPH_OTP = 'SUCCESS_BUILD_CANDIDATE_GRAPH_OTP';

export const ERROR_BUILD_CANDIDATE_BASE_GRAPH_OTP = 'ERROR_BUILD_CANDIDATE_BASE_GRAPH_OTP';
export const REQUEST_BUILD_CANDIDATE_BASE_GRAPH_OTP = 'REQUEST_BUILD_CANDIDATE_BASE_GRAPH_OTP';
export const SUCCESS_BUILD_CANDIDATE_BASE_GRAPH_OTP = 'SUCCESS_BUILD_CANDIDATE_BASE_GRAPH_OTP';
...
export const RECEIVED_M2M_CLIENTS = 'RECEIVED_M2M_CLIENTS';
export const ERROR_M2M_CLIENTS = 'ERROR_M2M_CLIENTS';
export const CREATED_M2M_CLIENT = 'CREATED_M2M_CLIENT';
export const UPDATED_M2M_CLIENT = 'UPDATED_M2M_CLIENT';
export const DELETED_M2M_CLIENT = 'DELETED_M2M_CLIENT';
export const FAILED_M2M_CLIENT_OPERATION = 'FAILED_M2M_CLIENT_OPERATION';
